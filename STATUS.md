...
> 752 tests across 25 groups, all green (+ 246-case djot-ref gate,
...
+ 89 Elaborate + 19 Render.Html + 1 Render.Dom + 87 AA.Pass + 88 AA.Typed
...
633 Cribrum. 10 TEAWeb.Html + 9 TEAWeb.Html.Typed + 8 TEAWeb.Html.Accessible
...
= 119 TEAWeb. Plus the djot-ref reference-suite gate (`tools/run-djotref/`,
246 corpus tests against a 225-test baseline; separate harness from the
in-suite tests). **Total: 752 in-suite tests, plus 246 djot-ref tests (225
